...
c..............................................................................
      SUBROUTINE SPLINE_1d(XI,YI,NI,X,Y)
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      DIMENSION XI(NI),YI(NI),Y2(NI)
      call SPLINE(XI,YI,NI,1.5E+30,1.5E+30,Y2)
      call SPLINT(XI,YI,Y2,NI,X,Y)
      print *,X,Y 
      END SUBROUTINE SPLINE_1d
 
      SUBROUTINE SPLINE_2d(X1I,X2I,YAI,M,N,X1,X2,Y)
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      DIMENSION X1I(M),X2I(N),YAI(M,N),Y2A(M,N)
C      print *,M,N,X1,x2,YAI(50,50)
      call SPLIE2(X1I,X2I,YAI,M,N,Y2A)
      call SPLIN2(X1I,X2I,YAI,Y2A,M,N,X1,X2,Y)
